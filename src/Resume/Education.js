    ...
    return (
      <div className={css.educationItem}>
        <div className={css.header}>
          <div className={css.institution}>{this.props.education.institution}</div>
          <div className={css.dateRange}>
            <DateRange start={this.props.education.startDate} end={this.props.education.endDate} />
          </div>
        </div>
        ...
        <ul className={css.awards}>
          {this.props.education.awards.map(award => <li key={award}>{award}</li>)}
        </ul>
      </div>
    )
  }
